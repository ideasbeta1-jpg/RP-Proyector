      ...
      <div className="w-full max-w-sm rounded-xl bg-slate-900 p-6 shadow-2xl">
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            className="rounded bg-slate-700 px-4 py-2.5 text-left text-sm text-slate-200 hover:bg-slate-600"
          >
            <span className="font-medium">Mantener local</span>
            <span className="ml-2 text-xs text-slate-400">No importar la versión de la nube</span>
          </button>
          <button
            onClick={() => onResolve('use_cloud')}
            className="rounded bg-sky-800 px-4 py-2.5 text-left text-sm text-slate-200 hover:bg-sky-700"
          >
            <span className="font-medium">Usar versión de la nube</span>
            <span className="ml-2 text-xs text-slate-400">Reemplaza tu versión local</span>
          </button>
          <button
          ...
          >
            ...
            <span className="ml-2 text-xs text-slate-400">Importa con nuevo ID</span>
          </button>
        </div>
      </div>
    </div>
